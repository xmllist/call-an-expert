...
-- Insert parent skill categories first
...
-- Insert child skill categories with parent UUID references
INSERT INTO skill_categories (name, slug, parent_id)
SELECT
  child.name,
  child.slug,
  parent.id
...
JOIN skill_categories parent ON parent.slug = child.parent_slug;
